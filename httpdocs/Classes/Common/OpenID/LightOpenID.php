 ...
 * array $config which contains host, identity and returnUrl
 *
 * The function setIdentity was added to accommodate for this change.
 */
...
class LightOpenID
{
    ...
    function __construct($config)
    {
        ...
        $this->setIdentity('identity', $config['identity']);
        $this->returnUrl = $config['return'];

    }

    /**
     * Custom added to enable passing the config to the constructor
     *
     * @param $name
     * @param $value
     */
